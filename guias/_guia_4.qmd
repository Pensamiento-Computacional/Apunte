...
1. El siguiente código intenta obtener el último elemento de una lista, pero produce un error. Identificá por qué falla y corregilo.
    ...
    print(obtener_ultimo(numeros))
    ```

2. El siguiente código intenta modificar una tupla, pero produce un error. Explicá por qué ocurre y proponé una solución alternativa.
    ...
    mi_tupla = (1, 2, 3)
    resultado = cambiar_segundo_elemento(mi_tupla, 100)
    print(resultado)
    ```

3. El siguiente código intenta contar la cantidad de veces que aparece cada letra en una palabra usando un diccionario, pero tiene un error. Identificá cuál es y corregilo.
