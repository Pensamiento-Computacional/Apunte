...
1. El siguiente código intenta calcular el promedio de tres números, pero tiene un error. Identificá cuál es y corregilo.
...
2. El siguiente código intenta convertir una temperatura de Celsius a Fahrenheit, pero el resultado no es el esperado. Identificá el error y corregilo.
...
3. El siguiente código intenta concatenar un nombre con un número, pero produce un error. Identificá por qué falla y proponé una solución.
    ...
    mi_usuario = crear_usuario("usuario", 123)
    print(mi_usuario)
    ```
