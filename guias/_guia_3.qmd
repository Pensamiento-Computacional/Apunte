...
1. El siguiente código intenta verificar si un número está entre 1 y 10 (inclusive), pero no funciona correctamente para todos los casos. Identificá el error lógico y corregilo.
...
2. El siguiente código intenta sumar los números del 1 al 5 usando un ciclo while, pero entra en un bucle infinito. Identificá el error y corregilo.
    ...
    resultado = sumar_hasta(5)
    print("La suma es:", resultado)
    ```

3. El siguiente código intenta contar cuántos números pares hay en un rango, pero el resultado siempre es incorrecto. Identificá el error y corregilo.
    ...
    resultado = contar_pares(1, 10)
    print("Cantidad de pares:", resultado)  # Debería dar 4 (2, 4, 6, 8)
    ```
