...
4. Mostrar las primeras 3 columnas
5. Mostrar las últimas 3 columnas
...
1. Graficar las funciones obtenidas en el ejercicio 3 de Numpy, usando los números del 1 al 100 del eje x. Hacerlo primero en un mismo gráfico y luego las 4 en el mismo.
...
5. **Desafio** (obligatorio): Teniendo la planilla de notas del primer parcial del 1C2024 de los alumnos de la materia "Pensamiento Computacional", importar los datos como dataframe usando el siguiente código:
