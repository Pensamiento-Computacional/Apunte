...
5. Crear un programa que le solicite al usuario un número, y que determine si es par mostrando en pantalla un los mensajes "par" o "impar" según corresponda.\
Para determinr si un número es par o impar, podés ver qué pasa cuando lo dividís por 2. Si el resto es 0, es par, si el resto es 1, es impar. ¿Qué operador vimos para obtener el resto?

6. Escribir un programa que le pida al usuario su año de nacimiento, y que le diga qué edad tiene en el año actual.

7. Crear un programa que le solciite al usuario 5 enteros y que muestre por pantalla el promedio de ellos. Hacerlo de dos formas:
