...
| `find(subcadena)` | Devuelve el índice de la primera aparición de la subcadena en la cadena, o `-1` si no se encuentra. Cada vez que se llama, devuelve la siguiente aparición | `"Hola mundo".find("mundo")` devuelve `5` |
