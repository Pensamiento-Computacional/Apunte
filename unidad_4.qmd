...
:::{.callout-tip}
Las funciones a pasar como parámetro a `map` devuelven *valores transformados* del elemento original. Lo que hace `map` es aplicarla a cada uno de los elementos de la secuencia original.
:::
