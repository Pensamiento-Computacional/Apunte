...
:::{.callout-note}
Como los diccionarios no son secuencias, no tienen orden, por lo que no podemos obtener porciones de un diccionario usando *slices* o `[:]` como hacíamos con otras estructuras de datos.
:::
